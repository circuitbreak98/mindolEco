 ...
 * <li>설 명 : I/F 이동 마스터 배치 DB에 반영한다.</li>
 * <li>작성일 : 2012-01-16 09:00:00</li>
 * </ul>
 *  
 * @author 이문규
 */
public class BASUKC08700 extends AbsBatchJobBiz {

	private static final String PROG_ID = "BASUKC08700";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			sqlMap.queryForObject("BASUKC08700.callSP_BASUKC08700", requestMap);

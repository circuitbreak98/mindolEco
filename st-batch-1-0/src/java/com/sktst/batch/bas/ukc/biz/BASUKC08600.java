 ...
 * @author 이문규
 */
public class BASUKC08600 extends AbsBatchJobBiz {

	private static final String PROG_ID = "BASUKC08600";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			sqlMap.queryForObject("BASUKC08600.callSP_BASUKC08600", requestMap);

 ...
 * <li>설 명 : 기타상품재고 월 마감 </li>
 * <li>작성일 : 2009-08-14</li>
 * </ul>
 *
 * @author 이정현 (leejunghyun)
 */
public class DISDCL08200 extends AbsBatchJobBiz {

	private static final String PROG_ID = "DISDCL08200";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("DISDCL08200.execute.callSP_DISDCL08201");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("DISDCL08200.callSP_DISDCL08201", requestMap);

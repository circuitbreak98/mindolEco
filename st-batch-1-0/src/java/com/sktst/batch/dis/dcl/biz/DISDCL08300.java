 ...
 */
public class DISDCL08300 extends AbsBatchJobBiz {

	private static final String PROG_ID = "DISDCL08300";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("DISDCL08300.execute.callSP_DISDCL08301");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("DISDCL08300.callSP_DISDCL08301", requestMap);

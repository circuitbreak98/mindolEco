 ...
 * </ul>
 *
 * @author 이강수 (Lee Kang Su)
 * 
 *  CRON에 등록되어 
 * 
 */
public class DISDSM08400 extends AbsBatchJobBiz {

	private PrintWriter dataFile;
	private static final String PROG_ID = "DISDSM08400";
	private static final String OUT_FILE_ID = "DISDSM08400"; // 단말기 최종이력
	private static final String FILE_EXTENSION = ".dat";
	private static final String FILE_TIME_FORMAT = yyyymmddhhmi; 
	...
	private void getDBwriteDataFile(SqlMapClient sqlMap) throws Exception{
		...
		List resultList = (List) sqlMap.queryForList("DISDSM08400.getDisList");

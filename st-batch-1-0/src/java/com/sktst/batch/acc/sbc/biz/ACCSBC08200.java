 ...
 */
public class ACCSBC08200 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCSBC08200";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCSBC08200.execute.callSP_ACCSBC08200");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCSBC08200.callSP_ACCSBC08200", requestMap);

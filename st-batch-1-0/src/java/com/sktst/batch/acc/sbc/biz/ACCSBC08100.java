 ...
 */
public class ACCSBC08100 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCSBC08100";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCSBC08100.execute.callSP_ACCSBC08100");
		   ...
		   if(!"".equals(sProcDt)){
			   sqlMap.queryForObject("ACCSBC08100.callSP_ACCSBC08100", requestMap);
			}

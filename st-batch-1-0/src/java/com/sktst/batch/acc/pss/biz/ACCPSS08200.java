 ...
 * 
 */
public class ACCPSS08200 extends AbsBatchJobBiz {

	private PrintWriter dataFile;
	private static final String PROG_ID = "ACCPSS08200";
	private static final String OUT_FILE_ID = "TPSM87"; // 할부채권정산
	private static final String REC_TYP = "87"; // 레코드구분:할부채권정산

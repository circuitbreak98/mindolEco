 ...
 */
public class ACCDCL08230 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08230";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08230.execute.callSP_ACCDCL08230");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08230.callSP_ACCDCL08230", requestMap);

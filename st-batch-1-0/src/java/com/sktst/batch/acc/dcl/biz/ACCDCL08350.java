...
/**
 * <ul>
 * <li>업무 그룹명 : 요금입금 정산</li>
 * <li>설 명 : 요금입금정산 월마감 </li>
 * <li>작성일 : 2010-05-04</li>
 * </ul>
 *
 * @author 이강수 (leekangsu)
 */
public class ACCDCL08350 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08350";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			if( request.size() > 1 ) {
				...
				agency = (String)request.get("args2");
				log.debug(sDate + ".sDate");
				log.debug(sDate + ".agency");
			}
			...
			requestMap.put("OP_AGENCY", agency);
			requestMap.put("OP_USER", PROG_ID.substring(0, 10));
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08350.execute.callSP_ACCDCL08350");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08350.callSP_ACCDCL08350", requestMap);

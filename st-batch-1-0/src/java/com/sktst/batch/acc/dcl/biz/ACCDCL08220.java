 ...
 */
public class ACCDCL08220 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08220";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08220.execute.callSP_ACCDCL08220");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08220.callSP_ACCDCL08220", requestMap);

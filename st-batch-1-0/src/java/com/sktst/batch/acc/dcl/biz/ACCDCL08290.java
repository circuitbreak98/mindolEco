 ...
 * <li>설 명 : 소매거래 월마감. </li>
 * <li>작성일 : 2009-08-19</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08290 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08290";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08290.execute.callSP_ACCDCL08290");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08290.callSP_ACCDCL08290", requestMap);

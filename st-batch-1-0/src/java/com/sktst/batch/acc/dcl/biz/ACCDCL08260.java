 ...
 */
public class ACCDCL08260 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08260";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08260.execute.callSP_ACCDCL08260");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08260.callSP_ACCDCL08260", requestMap);

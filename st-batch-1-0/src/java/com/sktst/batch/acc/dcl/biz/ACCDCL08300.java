 ...
 * <li>설 명 : 단말기현금판매가를 계산하여 현금매출에 입력 또는 수정(상세테이블도 마찬가지). </li>
 * <li>작성일 : 2009-04-09</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08300 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08300";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출 
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08300.execute.callSP_ACCDCL08300");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08300.callSP_ACCDCL08300", requestMap);

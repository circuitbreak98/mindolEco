 ...
 */
public class ACCDCL08360 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08360";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08360.execute.callSP_ACCDCL08360");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08360.callSP_ACCDCL08360", requestMap);

 ...
 * <li>설 명 : 부가상품판매-부가서비스장려금/부가서비스수수료 일마감 </li>
 * <li>작성일 : 2009-04-27</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08180 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08180";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08180.execute.callSP_ACCDCL08180");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08180.callSP_ACCDCL08180", requestMap);

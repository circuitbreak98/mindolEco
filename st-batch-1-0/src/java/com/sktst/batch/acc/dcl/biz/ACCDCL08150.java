 ...
 */
public class ACCDCL08150 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08150";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08150.execute.callSP_ACCDCL08150");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08150.callSP_ACCDCL08150", requestMap);

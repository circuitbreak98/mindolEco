 ...
 */
public class ACCDCL08330 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08330";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08330.execute.callSP_ACCDCL08330");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08330.callSP_ACCDCL08330", requestMap);

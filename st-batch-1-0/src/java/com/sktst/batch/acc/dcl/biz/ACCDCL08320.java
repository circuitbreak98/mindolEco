 ...
 * <li>설 명 : 월마감 확정/해제 </li>
 * <li>작성일 : 2009-08-10</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08320 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08320";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08320.execute.callSP_ACCDCL08320");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08320.callSP_ACCDCL08320", requestMap);

 ...
 * </ul>
 *
 * @author 장화수 (janghwasu)
 */
public class ACCDCL08210 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08210";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출 
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08210.execute.callSP_ACCDCL08210");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08210.callSP_ACCDCL08210", requestMap);

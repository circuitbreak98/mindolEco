 ...
 * <li>설 명 : 장려금-추가판매지원금 일마감 </li>
 * <li>작성일 : 2009-04-27</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08200 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08200";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08200.execute.callSP_ACCDCL08200");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08200.callSP_ACCDCL08200", requestMap);

 ...
 * <li>설 명 : 확정현금매출/확정위탁수수료 월마감 </li>
 * <li>작성일 : 2009-06-30</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08280 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08280";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08280.execute.callSP_ACCDCL08280");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08280.callSP_ACCDCL08280", requestMap);

 ...
 */
public class ACCDCL08240 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08240";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08240.execute.callSP_ACCDCL08240");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08240.callSP_ACCDCL08240", requestMap);

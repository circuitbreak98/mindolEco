 ...
 */
public class ACCDCL01800 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL01800";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출 
			if(log.isDebugEnabled()){
				log.debug("ACCDCL01800.execute.callSP_ACCDCL01800");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL01800.callSP_ACCDCL01800", requestMap);

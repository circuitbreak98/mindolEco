 ...
 * <li>설 명 : 추가판매수수료 일마감 </li>
 * <li>작성일 : 2009-04-27</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08140 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08140";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08140.execute.callSP_ACCDCL08140");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08140.callSP_ACCDCL08140", requestMap);

 ...
 */
public class ACCDCL08250 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08250";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08250.execute.callSP_ACCDCL08250");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08250.callSP_ACCDCL08250", requestMap);

 ...
 */
public class ACCDCL08120 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08120";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08120.execute.callSP_ACCDCL08120");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08120.callSP_ACCDCL08120", requestMap);

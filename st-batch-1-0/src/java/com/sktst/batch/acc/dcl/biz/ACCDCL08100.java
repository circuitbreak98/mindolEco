 ...
 */
public class ACCDCL08100 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08100";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출 
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08100.execute.callSP_ACCDCL08100");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08100.callSP_ACCDCL08100", requestMap);

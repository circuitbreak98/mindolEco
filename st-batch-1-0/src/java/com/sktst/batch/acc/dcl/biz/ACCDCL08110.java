 ...
 */
public class ACCDCL08110 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08110";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08110.execute.callSP_ACCDCL08110");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08110.callSP_ACCDCL08110", requestMap);

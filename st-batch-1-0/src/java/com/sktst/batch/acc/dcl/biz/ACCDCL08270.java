 ...
 */
public class ACCDCL08270 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08270";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08270.execute.callSP_ACCDCL08270");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08270.callSP_ACCDCL08270", requestMap);

 ...
 * <li>설 명 : USIM 현금판매가 소급적용. </li>
 * <li>작성일 : 2009-04-09</li>
 * </ul>
 *
 * @author 이영진 (leeyoungjin)
 */
public class ACCDCL08310 extends AbsBatchJobBiz {

	private static final String PROG_ID = "ACCDCL08310";
	...
	public int execute(Map request) throws Exception {
		...
		try {
			...
			// 프로시저 호출
			if(log.isDebugEnabled()){
				log.debug("ACCDCL08310.execute.callSP_ACCDCL08310");
				log.debug("requestMap.toString()"+requestMap.toString());
			}
			sqlMap.queryForObject("ACCDCL08310.callSP_ACCDCL08310", requestMap);

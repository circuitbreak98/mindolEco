 ...
 * 
 */
public class ACCSSS08200 extends AbsBatchJobBiz {

	private PrintWriter dataFile;
	private static final String PROG_ID = "ACCSSS08200";
	private static final String OUT_FILE_ID = "TPSM90"; // 장려금정산
	private static final String REC_TYP = "89"; // 레코드구분:장려금정산

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2010-04-07 14:31:55</li>
 * </ul>
 *
 * @author 전현주 (junhyunjoo)
 */
public class ADMCNR00700 extends BaseBizUnit {
	...
	public IDataSet getConnectListByUserGrp(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("getConnectListByUserGrp method start");
		}

		IRecordSet rs = queryForRecordSet("ADMCNR00700.getConnectListByUserGrp",

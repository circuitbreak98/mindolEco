 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2010-04-07 13:45:10</li>
 * </ul>
 *
 * @author 전현주 (junhyunjoo)
 */
public class ADMCNR00800 extends BaseBizUnit {
	...
	public IDataSet getConnectListByUser(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("getConnectListByUser method start");
		}

		IRecordSet rs = queryForRecordSet("ADMCNR00800.getConnectListByUser",

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2009-09-02 15:29:46</li>
 * </ul>
 *
 * @author 정재열 (jungjaeyul)
 */
public class ADMCNR00200 extends BaseBizUnit {
	...
	public IDataSet getMenuList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("getMenuList method start");
		}

		IRecordSet rs = queryForRecordSet("ADMCNR00200.getMenuList",

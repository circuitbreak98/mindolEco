 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-07-21 16:46:51</li>
 * </ul>
 *
 * @author 전미량 (jeonmiryang)
 */
public class DISDCO01000 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getProdList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("DISDCO01000.getProdList method start >>>");
		}

		IRecordSet rs = queryForRecordSet("DISDCO01000.getProdList",

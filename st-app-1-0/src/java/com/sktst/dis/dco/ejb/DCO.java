 ...
 */
public interface DCO extends javax.ejb.EJBObject {
	 ...
	 * @return 요청처리 완료후 작성된 응답정보를 Wrapping하고 있는 DataSet 객체
	 */
	IDataSet getCommList(IDataSet requestData, IOnlineContext onlineCtx)
			throws RemoteException;
	 ...
	 * @return 요청처리 완료후 작성된 응답정보를 Wrapping하고 있는 DataSet 객체
	 */
	IDataSet getProdInfoBySerNum(IDataSet requestData, IOnlineContext onlineCtx)
			throws RemoteException;

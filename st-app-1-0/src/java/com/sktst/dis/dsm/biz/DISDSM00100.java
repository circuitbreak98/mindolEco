 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-11-02 09:05:11</li>
 * </ul>
 *
 * @author 김만수 (kimmansoo)
 */
public class DISDSM00100 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getDisDsm100(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("DISDSM00100.getDisDsm100 method start");
		}

		IRecordSet rs = queryForRecordSet("DISDSM00100.getDisDsm100",

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-11-03 17:05:55</li>
 * </ul>
 *
 * @author 김만수 (kimmansoo)
 */
public class DISDSM00300 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getDisDsm300(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("DISDSM00300.getDisDsm300 method start");
		}

		IRecordSet rs = queryForRecordSet("DISDSM00300.getDisDsm300",

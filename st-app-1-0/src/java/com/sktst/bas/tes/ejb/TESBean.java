...
package com.sktst.bas.tes.ejb;

import nexcore.framework.core.biz.AbsBizSlsBean;
import nexcore.framework.core.data.IDataSet;
import nexcore.framework.core.data.IOnlineContext;
import nexcore.framework.core.exception.BaseException;
import com.sktst.bas.tes.biz.TEST003;

/**
 * <ul>
 * <li>업무 그룹명 : 프로젝트/SKTST/기준정보</li>
 * <li>설 명 : </li>
 * <li>작성일 : 2011-11-30 11:25:40</li>
 * </ul>
 *
 * @author 권현호 (kwonhyunho)
 */
public class TESBean extends AbsBizSlsBean {
	...
	public IDataSet getDeal(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		// Step1. 업무 컴포넌트 룩업
		TEST003 bizUnit = (TEST003) lookupBizUnit(TEST003.class);
		...
		try {
			...
			// Step2. 업무로직 호출
			output = bizUnit.getDeal(requestData, onlineCtx);

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2013-04-04 16:27:41</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class BASPDM00940 extends BaseBizUnit {
	...
	public IDataSet getProdDtlPrice(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("getProdDtlPrice method start");
		}

		IRecordSet rs = queryForRecordSet("BASPDM00940.getProdDtlPrice",

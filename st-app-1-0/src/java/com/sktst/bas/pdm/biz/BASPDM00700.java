 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-07-12 09:40:31</li>
 * </ul>
 *
 * @author 전현주 (junhyunjoo)
 */
public class BASPDM00700 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getUserProdListByProdCl(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("getUserProdListByProdCl method start");
		}
		
		IRecordSet rs = queryForRecordSet("BASPDM00700.getUsedProdList",

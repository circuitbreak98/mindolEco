 ...
 * <li>설 명 : 거래처 인터페이스 관리</li>
 * <li>작성일 : 2009-04-15 14:19:01</li>
 * </ul>
 *
 * @author 최승호 (choiseungho)
 */
public class BASPRM08100 extends BaseBizUnit {
	...
	public IDataSet getDealIfList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("BASPRM08100.getDealIfList method start");
		}

		// 2. CRUD 처리
		IRecordSet rs = queryForRecordSet("BASPRM08100.getDealIfList",

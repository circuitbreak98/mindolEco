 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2010-09-17 15:24:14</li>
 * </ul>
 *
 * @author 전현주 (junhyunjoo)
 */
public class BASUSM01300 extends BaseBizUnit {
	...
	public IDataSet getPortalUserInfoList(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("getPortalUserInfoList method start");
		}

		IRecordSet rs = queryForRecordSet("BASUSM01300.getPortalUserInfoList",

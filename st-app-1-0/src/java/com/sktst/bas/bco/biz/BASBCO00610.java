 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2009-02-04 20:30:56</li>
 * </ul>
 *
 * @author 심연정 (shimyunjung)
 */
public class BASBCO00610 extends BaseBizUnit {
	...
	public IDataSet getColor(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("BASBCO00610.getColor method start >>>");
		}

		IRecordSet rs = queryForRecordSet("BASBCO00610.getColor",

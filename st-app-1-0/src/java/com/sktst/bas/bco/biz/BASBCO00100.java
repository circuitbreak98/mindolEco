 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2009-01-15 16:47:03</li>
 * </ul>
 *
 * @author 심연정 (shimyunjung)
 */
public class BASBCO00100 extends BaseBizUnit {
	...
	public IDataSet getOrgList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("getOrgList method start");
		}

		IRecordSet rs = queryForRecordSet("BASBCO00100.getOrgList", requestData
	...
	public IDataSet getOrg(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		Log log = LogManager.getLog(onlineCtx);
		if (log.isDebugEnabled()) {
			log.debug("getOrg method start");
		}

		IRecordSet rs = queryForRecordSet("BASBCO00100.getOrg",

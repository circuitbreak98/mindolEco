 ...
 * <li>설 명 : 전체 조직 트리 취득</li>
 * <li>작성일 : 2009-04-20 16:38:58</li>
 * </ul>
 *
 * @author 최승호 (choiseungho)
 */
public class BASBCO1500 extends BaseBizUnit {
	...
	public IDataSet getFullOrgTree(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("BASBCO1500.getFullOrgTree method start");
		}

		// 2. CRUD 처리
		IRecordSet rs = queryForRecordSet("BASBCO1500.getFullOrgTree",

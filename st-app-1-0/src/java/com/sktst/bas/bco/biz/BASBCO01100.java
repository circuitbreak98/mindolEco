 ...
 * <li>설 명 : 조직 정보를 트리로 구성</li>
 * <li>작성일 : 2009-02-26 13:58:18</li>
 * </ul>
 *
 * @author 최승호 (choiseungho)
 */
public class BASBCO01100 extends BaseBizUnit {
	...
	public IDataSet getOrgTree(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("BASBCO01100.getOrgTree method start");
		}

		// 2. CRUD 처리
		IRecordSet rs = queryForRecordSet("BASBCO01100.getOrgTree",

...
package com.sktst.bas.tmp.ejb;

import nexcore.framework.core.biz.AbsBizSlsBean;
import nexcore.framework.core.data.IDataSet;
import nexcore.framework.core.data.IOnlineContext;
import nexcore.framework.core.exception.BaseException;
import com.sktst.bas.tmp.biz.BASTMP00100;

/**
 * <ul>
 * <li>업무 그룹명 : 프로젝트/SKTPS/기준정보</li>
 * <li>설 명 : </li>
 * <li>작성일 : 2009-03-18 21:36:23</li>
 * </ul>
 *
 * @author 원종윤 (wonjongyoon)
 */
public class TMPBean extends AbsBizSlsBean {
	...
	public IDataSet addUkeyLog(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		// Step1. 업무 컴포넌트 룩업
		BASTMP00100 bizUnit = (BASTMP00100) lookupBizUnit(BASTMP00100.class);
		...
		try {
			...
			// Step2. 업무로직 호출
			output = bizUnit.addUkeyLog(requestData, onlineCtx);

...
import com.sktst.bas.sdm.biz.BASSDM00100;
 ...
 */
public class SDMBean extends AbsBizSlsBean {
	...
	public IDataSet getSalesDayList(IDataSet requestData,
		...
		// Step1. 업무 컴포넌트 룩업
		BASSDM00100 bizUnit = (BASSDM00100) lookupBizUnit(BASSDM00100.class);
		...
		try {
			...
			// Step2. 업무로직 호출
			output = bizUnit.getSalesDayList(requestData, onlineCtx);
	...
	public IDataSet saveSalesDayList(IDataSet requestData,
		...
		try {
			...
			// Step2. 업무로직 호출
			output = bizUnit.saveSalesDayList(requestData, onlineCtx);

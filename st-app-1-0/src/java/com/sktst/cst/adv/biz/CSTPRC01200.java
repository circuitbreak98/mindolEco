 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2012-05-14 15:31:02</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTPRC01200 extends BaseBizUnit {
	...
	public IDataSet getCornPrchsList(IDataSet requestData,
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTPRC01200.getCornPrchsList",
		...
		IRecordSet dtl = queryForRecordSet("CSTPRC01200.getCornPrchsDtlList",
				requestData.getFieldMap(), onlineCtx);
...
//log.debug("requestData : " + requestData);
					...
					update("CSTPRC01200.updateCornPrchsOp", rs1.getRecord(i),
							onlineCtx);
						
					INN inn = (INN) lookupBizComponent("sktst.dis.INN");
					if (rs1.get(i, "CORN_PRCHS_OP_YN").equals("N")) {
						try {
						...
						if (rs1.get(i, "CORN_PRCHS_OP_YN").equals("Y")){
							try {

 ...
 * <li>업무 그룹명 : </li>
 * <li>설 명 : </li>
 * <li>작성일 : 2014-08-19 17:45:17</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTADV01600 extends BaseBizUnit {
		...
		if (rs != null) {
			for (int i = 0; i < rs.getRecordCount(); i++) {
				if (rs.get(i, "PRC_CHECK").equals("1")) {
					update("CSTADV01600.updatePrchsConfirmYes",
	...
	public IDataSet getPrchsConformList(IDataSet requestData,
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTADV01600.getPrchsConfirmList",

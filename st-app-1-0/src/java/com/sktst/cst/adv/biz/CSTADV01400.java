 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2012-03-14 14:47:19</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTADV01400 extends BaseBizUnit {
	...
	public IDataSet getConsultMgmtRtn(IDataSet requestData,
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTADV01400.getConsultMgmtRtn",
		...
		if (rs != null) {
			for (int i = 0; i < rs.getRecordCount(); i++) {
				if (rs.get(i, "PRC_CHECK").equals("1")) {
					update("CSTADV01400.updateConsultMgmtRtn", rs.getRecord(i),
							onlineCtx);
				}
			}
		}

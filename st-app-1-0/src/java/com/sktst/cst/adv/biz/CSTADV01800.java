 ...
 * <li>업무 그룹명 : </li>
 * <li>설 명 : </li>
 * <li>작성일 : 2015-05-11 10:48:24</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTADV01800 extends BaseBizUnit {
	...
	public IDataSet getSaleEqp(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTADV01800.getSaleEqp", requestData
	...
	public IDataSet saveSaleEqp(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		insert("CSTADV01800.addSaleEqp", mSaleEqp, onlineCtx);
		update("CSTADV01800.updateConsultSaleEqp", mSaleEqp, onlineCtx);
		update("CSTADV01800.updatePrchsSaleEqp", mSaleEqp, onlineCtx);
		update("CSTADV01800.updateSaleEqp", mSaleEqp, onlineCtx);

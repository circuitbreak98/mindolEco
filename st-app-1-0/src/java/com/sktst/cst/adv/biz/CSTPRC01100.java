 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2012-03-20 16:37:16</li>
 * </ul>
 *
 * @author 전미량 (jeonmiryang)
 */
public class CSTPRC01100 extends BaseBizUnit {
	 ...
	 */
	public IDataSet getExcelLst(IDataSet requestData, IOnlineContext onlineCtx) throws Exception {
		
		Log log = LogManager.getLog(onlineCtx);
		if (log.isDebugEnabled()) {
			log.debug("CSTPRC01100.getExcelLst method start >>>");
		}

		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTPRC01100.getExcelLst",
...
//		응답데이터를 생성한다.
		...
		rec.add("col_name4", "RES_NO"); 		// 복호화 컬럼4

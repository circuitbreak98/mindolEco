 ...
 * <li>업무 그룹명 : </li>
 * <li>설 명 : </li>
 * <li>작성일 : 2014-09-19 17:46:17</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTPRC01300 extends BaseBizUnit {
...
/*
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTPRC01300.getAsianaMilList",
		...
		IRecordSet dtl = queryForRecordSet("CSTPRC01300.getAsianaMilDtlList",
				requestData.getFieldMap());
...
*/
		...
		rec.add("col_name1", "ASIANA_CARD_NO"); // 복호화 컬럼1
		iSet.addRecord(rec);
...
//log.debug("requestData : " + requestData);
					...
					update("CSTPRC01300.updatePrchsAsiaMilOp", rs1.getRecord(i),
							onlineCtx);
						
					INN inn = (INN) lookupBizComponent("sktst.dis.INN");
					if (rs1.get(i, "ASIA_MIL_OP_YN").equals("N")) {
						try {
						...
						if (rs1.get(i, "ASIA_MIL_OP_YN").equals("Y")){
							try {

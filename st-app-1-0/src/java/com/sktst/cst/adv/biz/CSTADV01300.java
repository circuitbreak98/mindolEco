 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2012-01-12 15:39:09</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTADV01300 extends BaseBizUnit {
	 ...
	 * @throws  
	 */
	public IDataSet getInList(IDataSet requestData, IOnlineContext onlineCtx) throws Exception {

		Log log = LogManager.getLog(onlineCtx); 

		//질의를 수행한다. 
		IRecordSet rs = queryForRecordSet("CSTADV01300.getInList",

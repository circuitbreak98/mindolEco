 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-09-07 19:45:28</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTADV00900 extends BaseBizUnit {
	...
	public IDataSet getInCancelList(IDataSet requestData,
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTADV00900.getInCancelList",
		...
		if (rs != null) {
			for (int i = 0; i < rs.getRecordCount(); i++) {
				if (rs.get(i, "PRC_CHECK").equals("1")) {
					update("CSTADV00900.updateInCancel", rs.getRecord(i),
							onlineCtx);
				}
			}
		}

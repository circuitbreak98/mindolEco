 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2013-03-19 14:34:35</li>
 * </ul>
 *
 * @author 민동운 (mindongwoon)
 */
public class CSTSKN01100 extends BaseBizUnit {
	...
	public IDataSet getPrchsSknOpList(IDataSet requestData,
		...
		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("CSTSKN01100.getPrchsSknOpList",
		...
		IRecordSet dtl = queryForRecordSet("CSTSKN01100.getPrchsSknOpDtlList",
...
log.debug(" i : " + i + "dd");
					...
					if (log.isDebugEnabled()) {
						log.debug("savePrchs delete RemoteException rEx: " + rEx.getMessage());
					}
					throw new BizRuntimeException(
							rEx.getCause().toString().replace("nexcore.framework.core.exception.BizRuntimeException:",""));
					} catch (Exception ex) {
						if (log.isDebugEnabled()) {

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2012-04-18 09:50:07</li>
 * </ul>
 *
 * @author 전미량 (jeonmiryang)
 */
public class SALBOS00600 extends BaseBizUnit {
	...
	public IDataSet getOnlineProdList(IDataSet requestData,
		...
		if (log.isDebugEnabled()) {
			log.debug("SALBOS00600.getOnlineProdList method start >>>");
		}

		//질의를 수행한다.
		IRecordSet rs = queryForRecordSet("SALBOS00600.getOnlineProdList",
				requestData.getFieldMap());

		if (rs == null) {
			rs = new RecordSet("ds_temp");
		}

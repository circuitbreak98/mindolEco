 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2011-10-07 17:29:17</li>
 * </ul>
 *
 * @author 전희경 (jeonheekyung)
 */
public class SALBBS00100 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getSaleList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("getSaleDtList method start");
		}

		IRecordSet rs = queryForRecordSet("SALBBS00100.getSaleList", requestData
				.getFieldMap());

 ...
 * <li>설 명 : </li>
 * <li>작성일 : 2013-05-20 16:09:34</li>
 * </ul>
 *
 * @author 전미량 (jeonmiryang)
 */
public class SALCSS00100 extends com.sktst.common.base.BaseBizUnit {
	...
	public IDataSet getSaleList(IDataSet requestData, IOnlineContext onlineCtx) {
		...
		if (log.isDebugEnabled()) {
			log.debug("getSaleList method start");
		}

		IRecordSet rs = queryForRecordSet("SALCSS00100.getSaleList", requestData
				.getFieldMap());
